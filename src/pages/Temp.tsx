...
//       <div className="absolute inset-0 bg-linear-to-r from-cyan-400 to-light-blue-500 shadow-lg transform -skew-y-13 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
